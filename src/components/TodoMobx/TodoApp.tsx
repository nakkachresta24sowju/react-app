...
class TodoApp extends React.Component {
  ...
  render() {
    if (this.loading) {
      return (
        <img src="https://tap.ibhubs.in/react/assignments/assignment-10/preview/loading-view.png" />
      );
    } else if (this.networkError) {
      return (
        <img src="https://tap.ibhubs.in/react/assignments/assignment-10/preview/failure-view.png" />
      );
    } else if (this.notFound) {
      console.log("notfound", this.notFound);
      return (
        <img src="https://tap.ibhubs.in/react/assignments/assignment-10/preview/no-data-view.png" />
      );
